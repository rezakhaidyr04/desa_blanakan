...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="lg:col-span-1">
            ...
            <!-- Info Box -->
            <div class="bg-gradient-to-br from-teal-500 to-teal-700 rounded-2xl shadow-sm p-6 text-white">
                <h3 class="text-lg font-bold mb-3">Kontak Redaksi</h3>
                <p class="text-teal-100 text-sm mb-4">Punya informasi atau berita untuk dibagikan?</p>
                <div class="space-y-2 text-sm">
                    <div class="flex items-center gap-2">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path></svg>
                        info@desablanakan.id
                    </div>
                    <div class="flex items-center gap-2">
