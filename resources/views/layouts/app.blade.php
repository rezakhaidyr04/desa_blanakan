...
<body class="bg-slate-50 text-slate-800 antialiased flex flex-col min-h-screen">
    ...
    <!-- Search Modal -->
    <div id="search-modal" class="fixed inset-0 z-[70] bg-slate-900/50 backdrop-blur-sm hidden opacity-0 transition-opacity duration-300" role="dialog" aria-modal="true" aria-label="Pencarian">
            ...
            <div class="max-w-4xl mx-auto">
                <div class="flex items-center gap-4">
                    <div class="relative flex-1">
                        <input id="search-input" type="text" placeholder="Cari layanan, berita, atau informasi..." autocomplete="off" class="w-full pl-12 pr-4 py-4 bg-slate-50 border-none rounded-xl text-lg focus:ring-2 focus:ring-teal-500 outline-none">
                    ...
                    <button id="search-close" class="p-2 text-slate-500 hover:text-red-500 transition-colors" aria-label="Tutup pencarian">
                ...
                <div id="search-results" class="mt-4 hidden">
                    <div class="rounded-2xl border border-slate-100 bg-white shadow-sm overflow-hidden">
                        <div class="px-4 py-3 text-xs font-semibold text-slate-500 bg-slate-50">Hasil</div>
                        <div id="search-results-list" class="divide-y divide-slate-100"></div>
                    </div>
                    <div class="mt-2 text-xs text-slate-500">Tips: tekan <span class="font-semibold">Enter</span> untuk membuka hasil pertama, <span class="font-semibold">Esc</span> untuk menutup.</div>
                </div>
            </div>
        </div>
    </div>
