        ...
        <form action="{{ route('admin.services.store') }}" method="POST" class="space-y-6">
            ...
            <div>
                ...
                <input type="text" id="name" name="name" value="{{ old('name') }}" required
                    ...
                    placeholder="Contoh: Pembuatan e-KTP, Surat Keterangan, dll">
            </div>
            ...
            <div>
                ...
                <select id="icon" name="icon" required
                    ...
                    <option value="id-card">🪪 KTP/Identitas</option>
                    <option value="family">👨‍👩‍👧‍👦 Keluarga</option>
                    <option value="certificate">📜 Sertifikat</option>
                    <option value="letter">✉️ Surat</option>
                    <option value="building">🏛️ Pemerintahan</option>
            ...
            <div>
                ...
                <textarea id="requirements" name="requirements" rows="5"
                    class="w-full px-4 py-3 border border-slate-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-teal-500"
                    placeholder="Satu persyaratan per baris:&#10;Fotokopi KTP&#10;Fotokopi KK&#10;Pas foto 3x4">{{ old('requirements') }}</textarea>
            ...
            <div class="grid grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input type="text" id="cost" name="cost" value="{{ old('cost', 'Gratis') }}"
                        class="w-full px-4 py-3 border border-slate-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-teal-500"
                        placeholder="Gratis atau nominal biaya">
                </div>
            </div>
